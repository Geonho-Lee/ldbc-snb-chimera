...
echo "=============================================================="
echo "Setting driver files"
echo "=============================================================="
cp -r ${SCRIPT_DIR}/driver/base/benchmark.properties.sf${SF}.normal.base ${SCRIPT_DIR}/driver/run/benchmark.properties.sf${SF}.normal.base
cp -r ${SCRIPT_DIR}/driver/base/benchmark.properties.sf${SF}.hard.base ${SCRIPT_DIR}/driver/run/benchmark.properties.sf${SF}.hard.base
sed -i "s@(PG_GRAPH_CSV_DIR)@${PG_GRAPH_CSV_DIR}@g" ${SCRIPT_DIR}/driver/run/*
